  ...
  const fetchData = async () => {
    try {
      ...
      const [requestsRes, appointmentsRes] = await Promise.all([
        apiClient.getAppointmentRequests(),
              ...
              requests.length === 0 ? (
                ...
                <div className="space-y-4">
                  {requests.map((req, idx) => (
                    <div key={idx} className="card bg-yellow-50 border-l-4 border-yellow-600">
                ...
                {appointments.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {appointments.map((apt, idx) => (
                      <div key={idx} className="card bg-white border-l-4 border-blue-600">
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            <h3 className="text-lg font-semibold text-gray-800 mb-2">
                              {apt.patientName}
